...
export const trustedBy = {
  ...
  logos: [
    { name: 'DALDHIS Aluminium & Decoration', logo: '/brand/clients/daldhis.svg' },
    { name: 'Dalsom Travel Agency', logo: '/brand/clients/dalsom.svg' },
    { name: 'Waabil', logo: '/brand/clients/waabil.svg' },
    { name: 'Taagerso', logo: '/brand/clients/taagerso.svg' },
  ],
};
