...
export const site = {
  ...
  // WhatsApp — single source. Display number + derived wa.me link.
  whatsappDisplay: '+252 61 7221732',
  whatsapp: 'https://wa.me/252617221732',
  contact: {
    // confirm: should the office phone match the WhatsApp number? Left as-is for now.
...
export const subBrands = [
  {
    ...
    image: '/images/services/reesh_designs.jpeg',
    seo: {
  ...
  },
  {
    ...
    image: '/images/services/reesh_digital.jpeg',
    seo: {
  ...
  },
  {
    ...
    image: '/images/services/reesh_Media.jpeg',
    seo: {
  ...
  },
  {
    ...
    // TODO: awaiting official Reesh Web image. Clean device/website mockup for now.
    image:
  ...
  },
  {
    ...
    image: '/images/services/reesh_Print.jpeg',
    seo: {
...
// Every image genuinely depicts its category. Real Reesh/client assets are used
// where they fit; remaining slots use category-accurate stock.
// TODO: swap the stock entries with real Reesh project shots as they go live.
export const portfolio = [
  {
    title: 'Taagerso — Brand Identity System',
    category: 'Branding',
    image: '/images/services/reesh_digital.jpeg', // real brand-identity mockup set
  },
  {
    title: 'Creative Direction & Design',
    category: 'Branding',
    image: '/images/services/reesh_designs.jpeg', // real Reesh design visual
  },
  {
    title: 'Studio Video Production',
    category: 'Media',
    image: '/images/services/reesh_Media.jpeg', // real Reesh media crew
  },
  {
    title: 'Branded Print & Stationery',
    category: 'Print',
    image: '/images/services/reesh_Print.jpeg', // real Reesh print suite
  },
  {
    title: 'Social & Paid Campaign',
    category: 'Digital',
    image:
      'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Business Website & E-commerce',
    category: 'Web',
    image:
      'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Hospitality Brand Rollout',
    category: 'Hospitality',
    image:
      'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Retail Campaign & Media',
    category: 'Retail',
    image:
      'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1200&q=80',
  },
...
export const trustedBy = {
  ...
  // Client logos, rendered monochrome-white on the dark band.
  // TODO: replace the SVGs in public/brand/clients/ with official client
  // artwork (same filenames → no code change needed).
  logos: [
    { name: 'DALDHIS Aluminium & Decoration', logo: '/brand/clients/daldhis.png' },
    { name: 'Dalsom Travel Agency', logo: '/brand/clients/dalsom.png' },
    { name: 'Waabil', logo: '/brand/clients/waabil.png' },
    { name: 'Taagerso', logo: '/brand/clients/taagerso.png' },
    { name: 'Riqaab', logo: '/brand/clients/riqaab.png' },
  ],
};
